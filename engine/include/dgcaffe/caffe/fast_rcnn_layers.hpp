...
//  virtual std::vector<Dtype> arange(const Dtype start,const Dtype stop,const Dtype prob,const Dtype step);
//  virtual std::pair<std::vector<Dtype>, std::vector<Dtype> > meshgrid(Dtype x, Dtype y);

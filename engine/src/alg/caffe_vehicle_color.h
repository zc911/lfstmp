...
#ifndef PROJECT_CAFFE_VEHICLE_COLOR_H
#define PROJECT_CAFFE_VEHICLE_COLOR_H
#include <cassert>
...
public:
    typedef struct {
        ...
        string deploy_file;
        string model_file;
    } CaffeVehicleColorConfig;
    CaffeVehicleColor(const CaffeVehicleColorConfig &config);
    virtual ~CaffeVehicleColor();
...
private:
    ...
    bool device_setted_;
    CaffeVehicleColorConfig caffe_config_;
    Mat means_;
    int rescale_;
};
...
#endif //PROJECT_CAFFE_VEHICLE_COLOR_H

...
enum Operations
    ...
    OPERATION_FACE_ALIGNMENT = 1 << 11,
    OPERATION_FACE_QUALITY = 1 << 12,
    OPERATION_FACE_FEATURE_VECTOR = 1 << 13,
    OPERATION_DRIVER_BELT = 1 << 14,
    OPERATION_CODRIVER_BELT = 1 << 15,
    OPERATION_DRIVER_PHONE = 1 << 16,
    OPERATION_NON_VEHICLE_ATTR = 1 << 17,
    OPERATION_MAX = 1 << 63
};

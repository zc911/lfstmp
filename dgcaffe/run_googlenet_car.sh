...
argv1=./models/faster_rcnn_googlenet/detector/test.prototxt
#detection_model_trained_file
argv2=./models/faster_rcnn_googlenet/detector/googlenet_faster_rcnn_iter_48000.caffemodel
...
argv4=./models/faster_rcnn_googlenet/detector/deploy.prototxt
#classfication_trained_file
#argv5=./detection/faster_rcnn/detector/car_not_car_train_iter_30000.caffemodel
argv5=./models/faster_rcnn_googlenet/detector/car_not_car_train_iter_30000.caffemodel
#save_result_file

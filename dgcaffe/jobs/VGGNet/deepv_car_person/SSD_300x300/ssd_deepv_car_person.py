...
save_dir = "models/VGGNet/deepv_car_person/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/deepv_car_person/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/deepv_car_person/{}".format(job_name)

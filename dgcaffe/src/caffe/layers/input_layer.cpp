...
void InputLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  //std::cout << "In Input layer setup: " << std::endl;
  //std::cout << "num_shape" << num_shape << std::endl;
  //std::cout << "num_top" << num_top << std::endl;
  //std::cout << "bottom" << bottom.size() << std::endl;
  if (num_shape > 0) {
  ...
  //std::cout << "top" << top[0]->shape()[0] << std::endl;
  //std::cout << "top" << top[0]->shape()[1] << std::endl;
  //std::cout << "top" << top[0]->shape()[2] << std::endl;
  //std::cout << "top" << top[0]->shape()[3] << std::endl;
}

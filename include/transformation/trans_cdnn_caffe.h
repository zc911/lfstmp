#ifndef _dgfaceskd_trans_cdnn_caffe_h_
#define _dgfaceskd_trans_cdnn_caffe_h_
...
class CdnnCaffeTransformation : public Transformation {
	public:
		CdnnCaffeTransformation();
		virtual ~CdnnCaffeTransformation(void);

...
SimilarityService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_GetRankedCarVector_(SimilarityService_method_names[0], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetRankedFaceVector_(SimilarityService_method_names[1], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}

...
- Add Mapping API "/rec/index/txt" return txt file
- Integrate with new ranker and new feature extractor
- Maximum GPU memory
- Integrate with deep-data
### Bugs fixed
- DEEPVIDEO-329
- DEEPVIDEO-325
- /rec/index api dumped when request's type is 1
- markers' cutborads are incorrect

...
- Have the ability to SSD Detection standard size with config file
- Update dg plate algorithm: 
      - 1 Recognize more vehicle's plates.
      - 2 Use multiple threadpool to reduce the time cost
- Update interface:

...
std::unique_ptr<WitnessService::Stub> WitnessService::NewStub(const std::shared_ptr<::grpc::ChannelInterface> &channel,
...
::grpc::Status WitnessService::Stub::Recognize(::grpc::ClientContext *context,
...
::grpc::ClientAsyncResponseReader<::dg::model::WitnessResponse> *WitnessService::Stub::AsyncRecognizeRaw(::grpc::ClientContext *context,
                                                                                                         const ::dg::model::WitnessRequest &request,
...
::grpc::Status WitnessService::Stub::BatchRecognize(::grpc::ClientContext *context,
...
::grpc::ClientAsyncResponseReader<::dg::model::WitnessBatchResponse> *WitnessService::Stub::AsyncBatchRecognizeRaw(::grpc::ClientContext *context,
                                                                                                                   const ::dg::model::WitnessBatchRequest &request,
                                                                                                                   ::grpc::CompletionQueue *cq) {
...
::grpc::Status WitnessService::Stub::GetIndex(::grpc::ClientContext *context,
...
::grpc::ClientAsyncResponseReader<::dg::model::IndexResponse> *WitnessService::Stub::AsyncGetIndexRaw(::grpc::ClientContext *context,
                                                                                                      const ::dg::model::IndexRequest &request,
                                                                                                      ::grpc::CompletionQueue *cq) {
    return new ::grpc::ClientAsyncResponseReader<::dg::model::IndexResponse>(channel_.get(),
                                                                             cq,
                                                                             rpcmethod_GetIndex_,
                                                                             context,
                                                                             request);
...
::grpc::Status WitnessService::Stub::GetIndexTxt(::grpc::ClientContext *context,
...
::grpc::ClientAsyncResponseReader<::dg::model::IndexTxtResponse> *WitnessService::Stub::AsyncGetIndexTxtRaw(::grpc::ClientContext *context,
                                                                                                            const ::dg::model::IndexTxtRequest &request,
                                                                                                            ::grpc::CompletionQueue *cq) {
    return new ::grpc::ClientAsyncResponseReader<::dg::model::IndexTxtResponse>(channel_.get(),
                                                                                cq,
                                                                                rpcmethod_GetIndexTxt_,
                                                                                context,
                                                                                request);
}
...
WitnessService::Service::Service() {
    ...
    AddMethod(new ::grpc::RpcServiceMethod(
        ...
        ::grpc::RpcMethod::NORMAL_RPC,
        new ::grpc::RpcMethodHandler<WitnessService::Service,
                                     ::dg::model::IndexTxtRequest,
                                     ::dg::model::IndexTxtResponse>(
...
::grpc::Status WitnessService::Service::Recognize(::grpc::ServerContext *context,
                                                  const ::dg::model::WitnessRequest *request,
                                                  ::dg::model::WitnessResponse *response) {
    (void) context;
    (void) request;
...
::grpc::Status WitnessService::Service::BatchRecognize(::grpc::ServerContext *context,
                                                       const ::dg::model::WitnessBatchRequest *request,
                                                       ::dg::model::WitnessBatchResponse *response) {
    (void) context;
    (void) request;
...
::grpc::Status WitnessService::Service::GetIndex(::grpc::ServerContext *context,
                                                 const ::dg::model::IndexRequest *request,
                                                 ::dg::model::IndexResponse *response) {
    (void) context;
    (void) request;
...
::grpc::Status WitnessService::Service::GetIndexTxt(::grpc::ServerContext *context,
                                                    const ::dg::model::IndexTxtRequest *request,
                                                    ::dg::model::IndexTxtResponse *response) {
    (void) context;
    (void) request;

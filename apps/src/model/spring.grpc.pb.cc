...
std::unique_ptr<SpringService::Stub> SpringService::NewStub(const std::shared_ptr<::grpc::ChannelInterface> &channel,
...
::grpc::Status SpringService::Stub::IndexVehicle(::grpc::ClientContext *context,
...
::grpc::ClientAsyncResponseReader<::dg::model::NullMessage> *SpringService::Stub::AsyncIndexVehicleRaw(::grpc::ClientContext *context,
                                                                                                       const ::dg::model::VehicleObj &request,
                                                                                                       ::grpc::CompletionQueue *cq) {
    return new ::grpc::ClientAsyncResponseReader<::dg::model::NullMessage>(channel_.get(),
                                                                           cq,
                                                                           rpcmethod_IndexVehicle_,
                                                                           context,
                                                                           request);
}

::grpc::Status SpringService::Stub::BingoVehicle(::grpc::ClientContext *context,
                                                 const ::dg::model::VehicleObj &request,
                                                 ::dg::model::NullMessage *response) {
    return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_BingoVehicle_, context, request, response);
}

::grpc::ClientAsyncResponseReader<::dg::model::NullMessage> *SpringService::Stub::AsyncBingoVehicleRaw(::grpc::ClientContext *context,
                                                                                                       const ::dg::model::VehicleObj &request,
                                                                                                       ::grpc::CompletionQueue *cq) {
    return new ::grpc::ClientAsyncResponseReader<::dg::model::NullMessage>(channel_.get(),
                                                                           cq,
                                                                           rpcmethod_BingoVehicle_,
                                                                           context,
                                                                           request);
}
...
::grpc::Status SpringService::Service::IndexVehicle(::grpc::ServerContext *context,
                                                    const ::dg::model::VehicleObj *request,
                                                    ::dg::model::NullMessage *response) {
    (void) context;
    (void) request;
...
::grpc::Status SpringService::Service::BingoVehicle(::grpc::ServerContext *context,
                                                    const ::dg::model::VehicleObj *request,
                                                    ::dg::model::NullMessage *response) {
    (void) context;
    (void) request;

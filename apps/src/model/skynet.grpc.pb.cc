...
std::unique_ptr<SkynetService::Stub> SkynetService::NewStub(const std::shared_ptr<::grpc::ChannelInterface> &channel,
...
SkynetService::Stub::Stub(const std::shared_ptr<::grpc::ChannelInterface> &channel)
    : channel_(channel),
      rpcmethod_VideoRecognize_(SkynetService_method_names[0], ::grpc::RpcMethod::NORMAL_RPC, channel) { }

::grpc::Status SkynetService::Stub::VideoRecognize(::grpc::ClientContext *context,
...
::grpc::ClientAsyncResponseReader<::dg::model::SkynetResponse> *SkynetService::Stub::AsyncVideoRecognizeRaw(::grpc::ClientContext *context,
                                                                                                            const ::dg::model::SkynetRequest &request,
...
::grpc::Status SkynetService::Service::VideoRecognize(::grpc::ServerContext *context,
                                                      const ::dg::model::SkynetRequest *request,
                                                      ::dg::model::SkynetResponse *response) {
    (void) context;
    (void) request;

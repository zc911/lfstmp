...
template<>
struct is_proto_enum<::dg::model::ObjType>: ::google::protobuf::internal::true_type { };
template<>
inline const EnumDescriptor *GetEnumDescriptor<::dg::model::ObjType>() {
    return ::dg::model::ObjType_descriptor();
}
template<>
struct is_proto_enum<::dg::model::DataFmtType>: ::google::protobuf::internal::true_type { };
template<>
inline const EnumDescriptor *GetEnumDescriptor<::dg::model::DataFmtType>() {
    return ::dg::model::DataFmtType_descriptor();
}
template<>
struct is_proto_enum<::dg::model::DBType>: ::google::protobuf::internal::true_type { };
template<>

...
public:
    ...
    public:
        ...
        virtual ::grpc::Status GetIndex(::grpc::ClientContext *context,
                                        const ::dg::model::IndexRequest &request,
                                        ::dg::model::IndexResponse *response) = 0;
        std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<::dg::model::IndexResponse>> AsyncGetIndex(::grpc::ClientContext *context,
                                                                                                              const ::dg::model::IndexRequest &request,
                                                                                                              ::grpc::CompletionQueue *cq) {
            return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<::dg::model::IndexResponse>>(
                AsyncGetIndexRaw(context, request, cq));
        }
        virtual ::grpc::Status GetIndexTxt(::grpc::ClientContext *context,
                                           const ::dg::model::IndexTxtRequest &request,
                                           ::dg::model::IndexTxtResponse *response) = 0;
        std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<::dg::model::IndexTxtResponse>> AsyncGetIndexTxt(::grpc::ClientContext *context,
                                                                                                                    const ::dg::model::IndexTxtRequest &request,
                                                                                                                    ::grpc::CompletionQueue *cq) {
            return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<::dg::model::IndexTxtResponse>>(
                AsyncGetIndexTxtRaw(context, request, cq));
        }
    private:
        ...
        virtual ::grpc::ClientAsyncResponseReaderInterface<::dg::model::IndexResponse> *AsyncGetIndexRaw
            (::grpc::ClientContext *context, const ::dg::model::IndexRequest &request, ::grpc::CompletionQueue *cq) = 0;
        virtual ::grpc::ClientAsyncResponseReaderInterface<::dg::model::IndexTxtResponse> *AsyncGetIndexTxtRaw
            (::grpc::ClientContext *context, const ::dg::model::IndexTxtRequest &request, ::grpc::CompletionQueue *cq) =
            0;
    };
    ...
    public:
        ...
        ::grpc::Status GetIndex(::grpc::ClientContext *context,
                                const ::dg::model::IndexRequest &request,
                                ::dg::model::IndexResponse *response) GRPC_OVERRIDE;
        std::unique_ptr<::grpc::ClientAsyncResponseReader<::dg::model::IndexResponse>> AsyncGetIndex(::grpc::ClientContext *context,
                                                                                                     const ::dg::model::IndexRequest &request,
                                                                                                     ::grpc::CompletionQueue *cq) {
            return std::unique_ptr<::grpc::ClientAsyncResponseReader<::dg::model::IndexResponse>>(AsyncGetIndexRaw(
                context,
                request,
                cq));
        }
        ::grpc::Status GetIndexTxt(::grpc::ClientContext *context,
                                   const ::dg::model::IndexTxtRequest &request,
                                   ::dg::model::IndexTxtResponse *response) GRPC_OVERRIDE;
        std::unique_ptr<::grpc::ClientAsyncResponseReader<::dg::model::IndexTxtResponse>> AsyncGetIndexTxt(::grpc::ClientContext *context,
                                                                                                           const ::dg::model::IndexTxtRequest &request,
                                                                                                           ::grpc::CompletionQueue *cq) {
            return std::unique_ptr<::grpc::ClientAsyncResponseReader<::dg::model::IndexTxtResponse>>(AsyncGetIndexTxtRaw(
                context,
                request,
                cq));
        }
    ...
    private:
        ...
        ::grpc::ClientAsyncResponseReader<::dg::model::IndexResponse> *AsyncGetIndexRaw
            (::grpc::ClientContext *context, const ::dg::model::IndexRequest &request, ::grpc::CompletionQueue *cq)
            GRPC_OVERRIDE;
        ::grpc::ClientAsyncResponseReader<::dg::model::IndexTxtResponse> *AsyncGetIndexTxtRaw
            (::grpc::ClientContext *context, const ::dg::model::IndexTxtRequest &request, ::grpc::CompletionQueue *cq)
            GRPC_OVERRIDE;
    ...
    public:
        ...
        virtual ::grpc::Status GetIndex(::grpc::ServerContext *context,
                                        const ::dg::model::IndexRequest *request,
                                        ::dg::model::IndexResponse *response);
        virtual ::grpc::Status GetIndexTxt(::grpc::ServerContext *context,
                                           const ::dg::model::IndexTxtRequest *request,
                                           ::dg::model::IndexTxtResponse *response);
    };
    ...
    public:
        ...
        // disable synchronous version of this method
        ::grpc::Status GetIndex(::grpc::ServerContext *context,
                                const ::dg::model::IndexRequest *request,
                                ::dg::model::IndexResponse *response) GRPC_FINAL GRPC_OVERRIDE {
            abort();
            return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
        }
        void RequestGetIndex(::grpc::ServerContext *context,
                             ::dg::model::IndexRequest *request,
                             ::grpc::ServerAsyncResponseWriter<::dg::model::IndexResponse> *response,
                             ::grpc::CompletionQueue *new_call_cq,
                             ::grpc::ServerCompletionQueue *notification_cq,
                             void *tag) {
    ...
    public:
        ...
        // disable synchronous version of this method
        ::grpc::Status GetIndexTxt(::grpc::ServerContext *context,
                                   const ::dg::model::IndexTxtRequest *request,
                                   ::dg::model::IndexTxtResponse *response) GRPC_FINAL GRPC_OVERRIDE {
            abort();
            return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
        }
        void RequestGetIndexTxt(::grpc::ServerContext *context,
                                ::dg::model::IndexTxtRequest *request,
                                ::grpc::ServerAsyncResponseWriter<::dg::model::IndexTxtResponse> *response,
                                ::grpc::CompletionQueue *new_call_cq,
                                ::grpc::ServerCompletionQueue *notification_cq,
                                void *tag) {
    ...
    typedef WithAsyncMethod_Recognize<WithAsyncMethod_BatchRecognize<WithAsyncMethod_GetIndex<
        WithAsyncMethod_GetIndexTxt<Service> > > > AsyncService;
    template<class BaseClass>

...
const ::google::protobuf::internal::GeneratedMessageReflection* SkynetRequest_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* SkynetResponse_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* SkynetResponse_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* SkynetRequestContext_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* SkynetRequestContext_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* SkynetRequestContext_ParamsEntry_descriptor_ =
        NULL;
const ::google::protobuf::Descriptor* SkynetOutput_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* SkynetOutput_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* SkynetRequestData_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* SkynetRequestData_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* SkynetResponseContext_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* SkynetResponseContext_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* SkynetResponseData_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* SkynetResponseData_reflection_ =
        NULL;
...
void protobuf_AssignDesc_skynet_2eproto() {
    ...
    SkynetRequestContext_ParamsEntry_descriptor_ =
            SkynetRequestContext_descriptor_->nested_type(0);
...
void protobuf_RegisterTypes(const ::std::string&) {
    ...
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            SkynetRequestContext_descriptor_,
            &SkynetRequestContext::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            SkynetRequestContext_ParamsEntry_descriptor_,
    ...
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            SkynetRequestData_descriptor_,
            &SkynetRequestData::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            SkynetResponseContext_descriptor_,
            &SkynetResponseContext::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            SkynetResponseData_descriptor_,
            &SkynetResponseData::default_instance());
}
...
void protobuf_AddDesc_skynet_2eproto() {
    ...
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
            "\n\014skynet.proto\022\010dg.model\032\014common.proto\032\014"
            "system.proto\"k\n\rSkynetRequest\022/\n\007Context"
            "\030\001 \001(\0132\036.dg.model.SkynetRequestContext\022)"
            "\n\004Data\030\002 \001(\0132\033.dg.model.SkynetRequestDat"
            "a\"n\n\016SkynetResponse\0220\n\007Context\030\001 \001(\0132\037.d"
            "g.model.SkynetResponseContext\022*\n\004Data\030\002 "
            "\001(\0132\034.dg.model.SkynetResponseData\"\345\001\n\024Sk"
            "ynetRequestContext\022\021\n\tSessionId\030\001 \001(\t\022%\n"
            "\004Type\030\002 \001(\0162\027.dg.model.RecognizeType\022(\n\007"
            "Storage\030\003 \001(\0132\027.dg.model.StorageConfig\022:"
            "\n\006Params\030\004 \003(\0132*.dg.model.SkynetRequestC"
            "ontext.ParamsEntry\032-\n\013ParamsEntry\022\013\n\003key"
            "\030\001 \001(\t\022\r\n\005value\030\002 \001(\t:\0028\001\"\222\001\n\014SkynetOutp"
            "ut\022\017\n\007Address\030\001 \001(\t\022\014\n\004Type\030\002 \001(\t\022\017\n\007Bit"
            "rate\030\003 \001(\005\022\013\n\003Fps\030\004 \001(\005\022\r\n\005Width\030\005 \001(\005\022\016"
            "\n\006Height\030\006 \001(\005\022\023\n\013ShotHotspot\030\007 \001(\010\022\021\n\tS"
            "napWidth\030\010 \001(\005\"\256\002\n\021SkynetRequestData\022\020\n\010"
            "SensorId\030\001 \001(\005\022\022\n\nSensorName\030\002 \001(\t\022\021\n\tSe"
            "nsorURI\030\003 \001(\t\022\022\n\nSensorType\030\004 \001(\t\022\r\n\005Wid"
            "th\030\005 \001(\005\022\016\n\006Height\030\006 \001(\005\022\013\n\003Fps\030\007 \001(\005\022$\n"
            "\010Hotspots\030\010 \003(\0132\022.dg.model.Cutboard\022(\n\014D"
            "isableAreas\030\t \003(\0132\022.dg.model.Cutboard\022\r\n"
            "\005DeepV\030\n \001(\t\022\024\n\014ResultOutput\030\013 \001(\t\022+\n\013Vi"
            "deoOutput\030\014 \001(\0132\026.dg.model.SkynetOutput\""
            "\027\n\025SkynetResponseContext\"\024\n\022SkynetRespon"
            "seData2V\n\rSkynetService\022E\n\016VideoRecogniz"
            "e\022\027.dg.model.SkynetRequest\032\030.dg.model.Sk"
            "ynetResponse\"\000b\006proto3",
            1102);
    ...
    ::google::protobuf::internal::OnShutdown(
            &protobuf_ShutdownFile_skynet_2eproto);
}
...
void SkynetRequest::InitAsDefaultInstance() {
    ...
    context_ =
            const_cast<::dg::model::SkynetRequestContext*>(&::dg::model::SkynetRequestContext::default_instance());
    data_ =
            const_cast<::dg::model::SkynetRequestData*>(&::dg::model::SkynetRequestData::default_instance());
}
...
void SkynetRequest::MergeFrom(const SkynetRequest& from) {
    if (GOOGLE_PREDICT_FALSE(&from == this))
        MergeFromFail(__LINE__);
    if (from.has_context()) {
        mutable_context()->::dg::model::SkynetRequestContext::MergeFrom(
                from.context());
    }
    if (from.has_data()) {
...
void SkynetResponse::InitAsDefaultInstance() {
    ...
    data_ =
            const_cast<::dg::model::SkynetResponseData*>(&::dg::model::SkynetResponseData::default_instance());
}
...
void SkynetResponse::MergeFrom(const SkynetResponse& from) {
    if (GOOGLE_PREDICT_FALSE(&from == this))
        MergeFromFail(__LINE__);
    if (from.has_context()) {
        mutable_context()->::dg::model::SkynetResponseContext::MergeFrom(
                from.context());
    }
    if (from.has_data()) {
...
SkynetRequestContext* SkynetRequestContext::New(
            ...
            case 4: {
                if (tag == 34) {
                    ...
                    parse_loop_Params: ::google::protobuf::scoped_ptr<
                            SkynetRequestContext_ParamsEntry> entry(
                            params_.NewEntry());
                    DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                            input, entry.get()));
...
void SkynetRequestContext::MergeFrom(const ::google::protobuf::Message& from) {
    ...
    const SkynetRequestContext* source =
            ::google::protobuf::internal::DynamicCastToGenerated<
                    const SkynetRequestContext>(&from);
    if (source == NULL) {
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {
        MergeFrom(*source);
...
void SkynetOutput::SerializeWithCachedSizes(
    ...
    // optional int32 Fps = 4;
    if (this->fps() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->fps(),
                                                                 output);
    }
    ...
    if (this->shothotspot() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteBool(
                7, this->shothotspot(), output);
    }

    // optional int32 SnapWidth = 8;
    if (this->snapwidth() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteInt32(
                8, this->snapwidth(), output);
    }
...
void SkynetRequestData::InitAsDefaultInstance() {
    _is_default_instance_ = true;
    videooutput_ =
            const_cast<::dg::model::SkynetOutput*>(&::dg::model::SkynetOutput::default_instance());
}
...
void SkynetRequestData::SharedCtor() {
    ...
    sensorname_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    sensoruri_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    sensortype_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    width_ = 0;
    height_ = 0;
    fps_ = 0;
    deepv_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    resultoutput_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    videooutput_ = NULL;
}
...
void SkynetRequestData::SharedDtor() {
    sensorname_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    sensoruri_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    sensortype_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    deepv_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    resultoutput_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (this != default_instance_) {
        delete videooutput_;
    }
...
SkynetRequestData* SkynetRequestData::New(
        ::google::protobuf::Arena* arena) const {
...
#define ZR_(first, last) do {\
  ::memset(&first, 0,\
    ...
    sensorname_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    sensoruri_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    sensortype_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    deepv_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    resultoutput_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (GetArenaNoVirtual() == NULL && videooutput_ != NULL)
        delete videooutput_;
    videooutput_ = NULL;
    ...
    for (;;) {
        ...
        switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(
            ...
            case 8: {
                ...
                if (input->ExpectTag(66))
                    goto parse_loop_Hotspots;
                if (input->ExpectTag(74))
                    goto parse_loop_DisableAreas;
                input->UnsafeDecrementRecursionDepth();
                break;
            }
            ...
            case 11: {
                if (tag == 90) {
                    ...
                    DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                            this->resultoutput().data(),
                            this->resultoutput().length(),
                            ::google::protobuf::internal::WireFormatLite::PARSE,
...
void SkynetRequestData::SerializeWithCachedSizes(
    ...
    // optional int32 Fps = 7;
    if (this->fps() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteInt32(7, this->fps(),
                                                                 output);
    }
...
void SkynetRequestData::MergeFrom(const SkynetRequestData& from) {
    ...
    if (from.sensoruri().size() > 0) {
        ...
        sensoruri_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.sensoruri_);
    }
    if (from.sensortype().size() > 0) {

        sensortype_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.sensortype_);
    }
    if (from.width() != 0) {
    ...
    if (from.deepv().size() > 0) {
        ...
        deepv_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.deepv_);
    }
    if (from.resultoutput().size() > 0) {

        resultoutput_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.resultoutput_);
    }
    if (from.has_videooutput()) {
        mutable_videooutput()->::dg::model::SkynetOutput::MergeFrom(
                from.videooutput());
    }
}
...
SkynetResponseContext* SkynetResponseContext::New(
        ::google::protobuf::Arena* arena) const {
...
void SkynetResponseContext::MergeFrom(const ::google::protobuf::Message& from) {
    ...
    const SkynetResponseContext* source =
            ::google::protobuf::internal::DynamicCastToGenerated<
                    const SkynetResponseContext>(&from);
    if (source == NULL) {
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {
        MergeFrom(*source);
...
SkynetResponseData* SkynetResponseData::New(
        ::google::protobuf::Arena* arena) const {

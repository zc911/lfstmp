...
static const char* SimilarityService_method_names[] = {
  "/dg.SimilarityService/GetRankedFaceVector",
  "/dg.SimilarityService/GetRankedCarVector",
...
::grpc::Status SimilarityService::Stub::GetRankedFaceVector(::grpc::ClientContext* context, const ::dg::FeatureRankingRequest& request, ::dg::FeatureRankingResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_GetRankedFaceVector_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::dg::FeatureRankingResponse>* SimilarityService::Stub::AsyncGetRankedFaceVectorRaw(::grpc::ClientContext* context, const ::dg::FeatureRankingRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::dg::FeatureRankingResponse>(channel_.get(), cq, rpcmethod_GetRankedFaceVector_, context, request);
}

::grpc::Status SimilarityService::Stub::GetRankedCarVector(::grpc::ClientContext* context, const ::dg::FeatureRankingRequest& request, ::dg::FeatureRankingResponse* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_GetRankedCarVector_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::dg::FeatureRankingResponse>* SimilarityService::Stub::AsyncGetRankedCarVectorRaw(::grpc::ClientContext* context, const ::dg::FeatureRankingRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::dg::FeatureRankingResponse>(channel_.get(), cq, rpcmethod_GetRankedCarVector_, context, request);
}
...
::grpc::Status SimilarityService::Service::GetRankedFaceVector(::grpc::ServerContext* context, const ::dg::FeatureRankingRequest* request, ::dg::FeatureRankingResponse* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status SimilarityService::Service::GetRankedCarVector(::grpc::ServerContext* context, const ::dg::FeatureRankingRequest* request, ::dg::FeatureRankingResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");

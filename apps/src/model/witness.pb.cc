...
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessRequest_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessBatchRequest_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessBatchRequest_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessResponse_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessResponse_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessBatchResponse_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessBatchResponse_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessRequestContext_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessRequestContext_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessRequestContext_ParamsEntry_descriptor_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessImage_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessImage_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessResponseContext_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessResponseContext_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessResponseContext_DebugTsEntry_descriptor_ =
        NULL;
const ::google::protobuf::Descriptor* WitnessResult_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* WitnessResult_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* RecognizedVehicle_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* RecognizedVehicle_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* RecognizedFace_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* RecognizedFace_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* VehicleModel_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* VehicleModel_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* LicensePlate_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* LicensePlate_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* SymbolItem_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* SymbolItem_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* Scene_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* Scene_reflection_ =
        NULL;
const ::google::protobuf::Descriptor* Symbol_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection* Symbol_reflection_ =
        NULL;
...
void protobuf_AssignDesc_witness_2eproto() {
    ...
    WitnessRequestContext_ParamsEntry_descriptor_ =
            WitnessRequestContext_descriptor_->nested_type(0);
    ...
    WitnessResponseContext_DebugTsEntry_descriptor_ =
            WitnessResponseContext_descriptor_->nested_type(0);
...
void protobuf_RegisterTypes(const ::std::string&) {
    ...
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessBatchRequest_descriptor_,
            &WitnessBatchRequest::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessResponse_descriptor_, &WitnessResponse::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessBatchResponse_descriptor_,
            &WitnessBatchResponse::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessRequestContext_descriptor_,
            &WitnessRequestContext::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessRequestContext_ParamsEntry_descriptor_,
            ::google::protobuf::internal::MapEntry<::std::string, ::std::string,
                    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
                    ::google::protobuf::internal::WireFormatLite::TYPE_STRING, 0>::CreateDefaultInstance(
                    WitnessRequestContext_ParamsEntry_descriptor_));
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessImage_descriptor_, &WitnessImage::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessResponseContext_descriptor_,
            &WitnessResponseContext::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            WitnessResponseContext_DebugTsEntry_descriptor_,
            ::google::protobuf::internal::MapEntry<::std::string,
                    ::dg::model::Time,
                    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ...
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
            RecognizedVehicle_descriptor_,
            &RecognizedVehicle::default_instance());
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_AddDesc_witness_2eproto() {
    ...
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
            ...
            "model.WitnessBatchResponse\"\000b\006proto3",
            2436);
    ...
    ::google::protobuf::internal::OnShutdown(
            &protobuf_ShutdownFile_witness_2eproto);
}
...
void WitnessRequest::InitAsDefaultInstance() {
    ...
    image_ =
            const_cast<::dg::model::WitnessImage*>(&::dg::model::WitnessImage::default_instance());
}
...
void WitnessRequest::MergeFrom(const WitnessRequest& from) {
    if (GOOGLE_PREDICT_FALSE(&from == this))
        MergeFromFail(__LINE__);
    if (from.has_context()) {
        mutable_context()->::dg::model::WitnessRequestContext::MergeFrom(
                from.context());
    }
    if (from.has_image()) {
...
WitnessBatchRequest* WitnessBatchRequest::New(
...
void WitnessBatchRequest::MergeFrom(const ::google::protobuf::Message& from) {
    ...
    const WitnessBatchRequest* source =
            ::google::protobuf::internal::DynamicCastToGenerated<
                    const WitnessBatchRequest>(&from);
    if (source == NULL) {
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {
        MergeFrom(*source);
...
void WitnessResponse::InitAsDefaultInstance() {
    ...
    result_ =
            const_cast<::dg::model::WitnessResult*>(&::dg::model::WitnessResult::default_instance());
}
...
void WitnessResponse::MergeFrom(const WitnessResponse& from) {
    if (GOOGLE_PREDICT_FALSE(&from == this))
        MergeFromFail(__LINE__);
    if (from.has_context()) {
        mutable_context()->::dg::model::WitnessResponseContext::MergeFrom(
                from.context());
    }
    if (from.has_result()) {
...
WitnessBatchResponse* WitnessBatchResponse::New(
        ::google::protobuf::Arena* arena) const {
...
void WitnessBatchResponse::MergeFrom(const ::google::protobuf::Message& from) {
    ...
    const WitnessBatchResponse* source =
            ::google::protobuf::internal::DynamicCastToGenerated<
                    const WitnessBatchResponse>(&from);
    if (source == NULL) {
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {
        MergeFrom(*source);
...
void WitnessRequestContext::SharedCtor() {
    ...
    _cached_size_ = 0;
    sessionid_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    type_ = 0;
    storage_ = NULL;
    params_.SetAssignDescriptorCallback(protobuf_AssignDescriptorsOnce);
...
WitnessRequestContext* WitnessRequestContext::New(
        ::google::protobuf::Arena* arena) const {
...
void WitnessRequestContext::Clear() {
    sessionid_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    type_ = 0;
        ...
        switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(
            ...
            case 7: {
                if (tag == 58) {
                    parse_Params:
                    DO_(input->IncrementRecursionDepth());
                    parse_loop_Params: ::google::protobuf::scoped_ptr<
                            WitnessRequestContext_ParamsEntry> entry(
                            params_.NewEntry());
                    DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                            input, entry.get()));
...
void WitnessRequestContext::SerializeWithCachedSizes(
    ...
    // optional .dg.model.RecognizeType Type = 5;
    if (this->type() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteEnum(5, this->type(),
                                                                output);
    }
    ...
    // map<string, string> Params = 7;
    {
        ...
        for (::google::protobuf::Map<::std::string, ::std::string>::const_iterator it =
                this->params().begin(); it != this->params().end(); ++it) {
...
void WitnessRequestContext::MergeFrom(const ::google::protobuf::Message& from) {
    ...
    const WitnessRequestContext* source =
            ::google::protobuf::internal::DynamicCastToGenerated<
                    const WitnessRequestContext>(&from);
    if (source == NULL) {
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {
        MergeFrom(*source);
...
void WitnessRequestContext::MergeFrom(const WitnessRequestContext& from) {
    ...
    if (from.has_storage()) {
        mutable_storage()->::dg::model::StorageConfig::MergeFrom(
                from.storage());
    }
}
...
void WitnessImage::InitAsDefaultInstance() {
    _is_default_instance_ = true;
    data_ =
            const_cast<::dg::model::Image*>(&::dg::model::Image::default_instance());
}
...
void WitnessImage::Clear() {
    ...
    data_ = NULL;
    sensorid_ = 0;
    sensorname_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
void WitnessResponseContext::InitAsDefaultInstance() {
    _is_default_instance_ = true;
    requestts_ =
            const_cast<::dg::model::Time*>(&::dg::model::Time::default_instance());
    responsets_ =
            const_cast<::dg::model::Time*>(&::dg::model::Time::default_instance());
}

WitnessResponseContext::WitnessResponseContext(
        const WitnessResponseContext& from)
        : ::google::protobuf::Message(),
          _internal_metadata_(NULL) {
    SharedCtor();
    MergeFrom(from);
...
void WitnessResponseContext::SharedCtor() {
    ...
    requestts_ = NULL;
    responsets_ = NULL;
    debugts_.SetAssignDescriptorCallback(protobuf_AssignDescriptorsOnce);
...
WitnessResponseContext* WitnessResponseContext::New(
        ::google::protobuf::Arena* arena) const {
...
void WitnessResponseContext::Clear() {
    ...
    message_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (GetArenaNoVirtual() == NULL && requestts_ != NULL)
        delete requestts_;
    requestts_ = NULL;
    if (GetArenaNoVirtual() == NULL && responsets_ != NULL)
        delete responsets_;
    responsets_ = NULL;
    debugts_.Clear();
}
        ...
        switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(
            ...
            case 6: {
                if (tag == 50) {
                    parse_DebugTs:
                    DO_(input->IncrementRecursionDepth());
                    parse_loop_DebugTs: ::google::protobuf::scoped_ptr<
                            WitnessResponseContext_DebugTsEntry> entry(
                            debugts_.NewEntry());
                    DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                            input, entry.get()));
                    (*mutable_debugts())[entry->key()].Swap(
                            entry->mutable_value());
                    DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                            entry->key().data(),
                            entry->key().length(),
...
void WitnessResponseContext::SerializeWithCachedSizes(
    ...
    // map<string, .dg.model.Time> DebugTs = 6;
    {
        ...
        for (::google::protobuf::Map<::std::string, ::dg::model::Time>::const_iterator it =
                this->debugts().begin(); it != this->debugts().end(); ++it) {
...
void WitnessResponseContext::MergeFrom(
...
void WitnessResult::SharedCtor() {
    ...
    ::google::protobuf::internal::GetEmptyString();
    _cached_size_ = 0;
    innerstatus_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    innermessage_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    image_ = NULL;
}
...
void WitnessResult::SharedDtor() {
    innerstatus_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    innermessage_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (this != default_instance_) {
        delete image_;
    }
...
void WitnessResult::Clear() {
    innerstatus_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    innermessage_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (GetArenaNoVirtual() == NULL && image_ != NULL)
        delete image_;
    image_ = NULL;
        ...
        switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(
            ...
            case 1: {
                if (tag == 10) {
                    ...
                    DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                            this->innerstatus().data(),
                            this->innerstatus().length(),
                            ::google::protobuf::internal::WireFormatLite::PARSE,
            ...
            case 2: {
                if (tag == 18) {
                    ...
                    DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                            this->innermessage().data(),
                            this->innermessage().length(),
                            ::google::protobuf::internal::WireFormatLite::PARSE,
            ...
            case 4: {
                ...
                if (input->ExpectTag(34))
                    goto parse_loop_Vehicles;
                if (input->ExpectTag(42))
                    goto parse_loop_Faces;
                input->UnsafeDecrementRecursionDepth();
                break;
            }
...
void WitnessResult::MergeFrom(const WitnessResult& from) {
    ...
    if (from.innerstatus().size() > 0) {
        ...
        innerstatus_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.innerstatus_);
    }
    if (from.innermessage().size() > 0) {

        innermessage_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.innermessage_);
    }
    if (from.has_image()) {
...
void RecognizedVehicle::InitAsDefaultInstance() {
    _is_default_instance_ = true;
    model_ =
            const_cast<::dg::model::VehicleModel*>(&::dg::model::VehicleModel::default_instance());
    cutboard_ =
            const_cast<::dg::model::Cutboard*>(&::dg::model::Cutboard::default_instance());
    color_ =
            const_cast<::dg::model::Color*>(&::dg::model::Color::default_instance());
    licenseplate_ =
            const_cast<::dg::model::LicensePlate*>(&::dg::model::LicensePlate::default_instance());
    scene_ =
            const_cast<::dg::model::Scene*>(&::dg::model::Scene::default_instance());
}
...
RecognizedVehicle* RecognizedVehicle::New(
        ::google::protobuf::Arena* arena) const {
...
void RecognizedVehicle::Clear() {
    if (GetArenaNoVirtual() == NULL && model_ != NULL)
        delete model_;
    model_ = NULL;
    if (GetArenaNoVirtual() == NULL && cutboard_ != NULL)
        delete cutboard_;
    cutboard_ = NULL;
    if (GetArenaNoVirtual() == NULL && color_ != NULL)
        delete color_;
    color_ = NULL;
    if (GetArenaNoVirtual() == NULL && licenseplate_ != NULL)
        delete licenseplate_;
    licenseplate_ = NULL;
    features_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void RecognizedVehicle::MergeFrom(const RecognizedVehicle& from) {
    ...
    if (from.has_licenseplate()) {
        mutable_licenseplate()->::dg::model::LicensePlate::MergeFrom(
                from.licenseplate());
    }
    if (from.features().size() > 0) {

        features_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.features_);
    }
    if (from.has_scene()) {
...
void VehicleModel::SharedCtor() {
    ...
    type_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    brand_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    subbrand_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    modelyear_.UnsafeSetDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    ishead_ = 0;
    confidence_ = 0;
}
...
void VehicleModel::SharedDtor() {
    type_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    brand_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    subbrand_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    modelyear_.DestroyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (this != default_instance_) {
    }
}
...
#define ZR_(first, last) do {\
  ::memset(&first, 0,\
    ...
    type_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    brand_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    subbrand_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    modelyear_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void VehicleModel::SerializeWithCachedSizes(
    ...
    if (this->subbrandid() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteInt32(
                3, this->subbrandid(), output);
    }

    // optional int32 ModelYearId = 4;
    if (this->modelyearid() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteInt32(
                4, this->modelyearid(), output);
    }
...
void VehicleModel::MergeFrom(const VehicleModel& from) {
    ...
    if (from.brand().size() > 0) {
        ...
        brand_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.brand_);
    }
    if (from.subbrand().size() > 0) {

        subbrand_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.subbrand_);
    }
    if (from.modelyear().size() > 0) {

        modelyear_.AssignWithDefault(
                &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
                from.modelyear_);
    }
    if (from.ishead() != 0) {
...
#define ZR_(first, last) do {\
  ::memset(&first, 0,\
    ...
    platenum_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (GetArenaNoVirtual() == NULL && cutboard_ != NULL)
        delete cutboard_;
    cutboard_ = NULL;
    color_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    type_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    confidence_ = 0;
...
void SymbolItem::Clear() {
    symbolid_ = 0;
    symbolname_.ClearToEmptyNoArena(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    symbols_.Clear();
}
...
void Scene::MergeFrom(const ::google::protobuf::Message& from) {
    if (GOOGLE_PREDICT_FALSE(&from == this))
        MergeFromFail(__LINE__);
    const Scene* source = ::google::protobuf::internal::DynamicCastToGenerated<
            const Scene>(&from);
    if (source == NULL) {
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {
...
void Symbol::MergeFrom(const ::google::protobuf::Message& from) {
    if (GOOGLE_PREDICT_FALSE(&from == this))
        MergeFromFail(__LINE__);
    const Symbol* source = ::google::protobuf::internal::DynamicCastToGenerated<
            const Symbol>(&from);
    if (source == NULL) {
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {

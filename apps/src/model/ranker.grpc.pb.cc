...
std::unique_ptr<SimilarityService::Stub> SimilarityService::NewStub(const std::shared_ptr<::grpc::ChannelInterface> &channel,
...
SimilarityService::Stub::Stub(const std::shared_ptr<::grpc::ChannelInterface> &channel)
    : channel_(channel),
      rpcmethod_GetRankedVector_(SimilarityService_method_names[0], ::grpc::RpcMethod::NORMAL_RPC, channel) { }

::grpc::Status SimilarityService::Stub::GetRankedVector(::grpc::ClientContext *context,
...
::grpc::Status SimilarityService::Service::GetRankedVector(::grpc::ServerContext *context,
                                                           const ::dg::model::FeatureRankingRequest *request,
                                                           ::dg::model::FeatureRankingResponse *response) {
    (void) context;
    (void) request;

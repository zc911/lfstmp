...
bool RankerAppsService::GetRankedVector(const FeatureRankingRequest* request,
...
bool RankerAppsService::getRankedCarVector(const FeatureRankingRequest* request,
                                           FeatureRankingResponse* response) {
...
bool RankerAppsService::getRankedFaceVector(

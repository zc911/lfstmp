...
::grpc::ClientAsyncResponseReader< ::model::FeatureRankingResponse>* SimilarityService::Stub::AsyncGetRankedVectorRaw(::grpc::ClientContext* context, const ::model::FeatureRankingRequest& request, ::grpc::CompletionQueue* cq) {
  return new ::grpc::ClientAsyncResponseReader< ::model::FeatureRankingResponse>(channel_.get(), cq, rpcmethod_GetRankedVector_, context, request);
}

...
int main(int argc, char const *argv[])
{
	...
	Recognition *recognition_step2 = create_recognition(recog_method::CDNN_CAFFE,"data/model/recognition/cdnn_caffe/0.0.6.v2", 0, true, false, batch_size);
    ...
    ofstream topN_score("topN_score.log");
#endif

...
int main(int argc, char const *argv[])
{
	...
	Recognition *recognition = create_recognition(recog_method::CDNN_CAFFE,"data/model/recognition/cdnn_caffe/posid_sample_apn", 0, true, false, batch_size);

...
int main(int argc, char const *argv[])
{
	...
	Recognition *recognition 	= create_recognition(recog_method::CDNN_CAFFE,"models/recognition_0.3.3",0,false );
	// Verification *verification 	= create_verifier(verif_method::EUCLID);
	*/

	string config_file = "models/dgface.json";
    Detector  *detector 		= create_detector_with_config(det_method::FCN, config_file, 0);
	Alignment *alignment 		= create_alignment_with_config(align_method::CDNN, config_file, -1);
	Recognition *recognition 	= create_recognition_with_config(recog_method::CDNN_CAFFE, config_file,0,false );

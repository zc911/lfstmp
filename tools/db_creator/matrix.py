...
conf = dict(
        ...
        uri_header = '',
        file_header = '/home/chenzhen/Workspace/cpp/Matrix/tools/db_creator/DG_blacklist/',
        timeout = 20,                   # timeout
...
#        print "#######" * 20
        ...
        for result in results:
            ...
            if not result.has_key("Vehicles"):
                continue
                ...
                while True:
                    ...
                    if conf['mode'] == 0:
                        if len(batch_list) >= 1:
                            ...
                            if r: 
                                if r['Result'].has_key("Pedestrian") and len(r['Result']['Pedestrian']) >0 and r['Result']['Pedestrian'][0].has_key('Face'):
                                    ...
                                    f.write(items[0] + " " + items[1] + " " + items[2] + " " + feature + " " + items[3] + '\n')
                                    self.cnt += 1
                                else:
                                    self.Error(conf['nofeature_file'], batch_list)
                            else: 

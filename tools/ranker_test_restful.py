...
RankerService = "http://192.168.2.21:7601/rank"
# Candidates number
...
def start():
    ...
    v_json_file = open("feature_modeltype.json")
    ...
    compareImageFile = open(CompareImage, "rb")
    ...
    bestCandidate = {}
    bestCandidate["Id"] = id
    bestCandidate["Feature"] = CompareImageFeature
    postJsonData["Candidates"].append(bestCandidate)
    ...
    resp = requests.post(RankerService, data=json.dumps(postJsonData), headers=postHeader)
    endTime = time.time()
